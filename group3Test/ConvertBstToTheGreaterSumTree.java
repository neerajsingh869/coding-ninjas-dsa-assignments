...
public class ConvertBstToTheGreaterSumTree {
...
For the second test case, after converting the given binary tree into the greater sum tree, the level order traversal of the tree will be {47, 64, 20, 69, 57, 35, 0}.
	...
	private static int getMaxSum(TreeNode1<Integer> root, int keyValue) {
	...
	private static void findGreaterSum(TreeNode1<Integer> currentRoot, TreeNode1<Integer> root,
	...
	private static void replaceWithGreaterSum(TreeNode1<Integer> root, HashMap<Integer, Integer> map) {
	...
	public static TreeNode1<Integer> convertBstToGreaterSum(TreeNode1<Integer> root) {
	...
	private static void printLevelOrder(TreeNode1<Integer> root) {
		if (root == null) {
			return;
		}
	...
	private static TreeNode1<Integer> takeInput() {
		...
		while (!q.isEmpty()) {
			TreeNode1<Integer> currentNode = q.poll();
			int leftChild = s.nextInt();

			if (leftChild != -1) {
				TreeNode1<Integer> leftNode = new TreeNode1<Integer>(leftChild);
			...
			if (rightChild != -1) {
				TreeNode1<Integer> rightNode = new TreeNode1<Integer>(rightChild);
	...
	public static void main(String[] args) {
		...
		while (t > 0) {
			...
			TreeNode1<Integer> root = takeInput();
			TreeNode1<Integer> bstToGreaterSum = convertBstToGreaterSum(root);
