...
-1
	...
	public static TreeNode2<Integer> sortedListToBST(Node<Integer> head)
    {
        if (head == null)
        {
            return null;
        ...
        TreeNode2<Integer> newNode = new TreeNode2<Integer>(mid.data);
        if (head == mid)
        {
            return newNode;
        }
    ...
    public static void print(TreeNode2<Integer> poi)
{
	if(poi==null)
		return;
	if(poi.left!=null)
...
public static boolean isValid(TreeNode2<Integer> root,Height height)
{
	if(root==null)
	{
		height.height=0;
	...
	public static void main(String[] args) {
		...
		while (t-- > 0) {
			...
			TreeNode2<Integer> root = sortedListToBST(head);
			TreeNode2<Integer> poi=root;
            in.clear();
			print(poi);
